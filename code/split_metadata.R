...
# inputs : Metadata tibble, split ASV table
...
#   and output data/processed/<16S or ITS>/asv_processed/<RE or RH or BS>_metadata.txt

clargs <- commandArgs(trailingOnly = TRUE)

library(tidyverse)

# Get sample ID filter based on ASV table
